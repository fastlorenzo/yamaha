...
import static org.openhab.binding.yamahamusiccast.YamahaMusicCastBindingConstants.ZONE_THING_TYPE;
import static org.openhab.binding.yamahamusiccast.YamahaMusicCastBindingConstants.Configs.CONFIG_ZONE;
...
import org.openhab.binding.yamahamusiccast.internal.state.DeviceInformationState;
...
public class ZoneDiscoveryService extends AbstractDiscoveryService {
    ...
    public ZoneDiscoveryService(BundleContext bundleContext) {
        super(YamahaMusicCastBindingConstants.ZONE_THING_TYPES_UIDS, 0, false);
